...
function createArray() {
  ...
  array = [];
  document.getElementById("result").innerHTML = `Array created with size: ${maxSize}`;
}
...
function addElementStandard() {
  ...
  if (array.length >= maxSize) {document.getElementById("result").innerHTML ="Array is full. Cannot add more elements.";
    return;
  }
  array.push(element);
  document.getElementById("result").innerHTML = `Array after adding (Standard): [${array}]`;
}
...
function addElementNonStandard() {
  ...
  document.getElementById("result").innerHTML = `Array after adding (Non-Standard): [${array}]`;
}
...
function deleteElementStandard() {
  ...
  if (index !== -1) {
    ...
    document.getElementById("result").innerHTML = `Array after deletion (Standard): [${array}]`;
  } else {
...
function deleteElementNonStandard() {
  ...
  if (elementFound) {
    array = newArray;
    document.getElementById("result").innerHTML = `Array after deletion (Non-Standard): [${array}]`;
  } else {
    document.getElementById( "result" ).innerHTML = `Element ${element} not found in the array.`;
  }
}
...
function checkValueStandard() {
  ...
  if (index !== -1) {
    document.getElementById("result").innerHTML = `Value ${value} found at index ${index} (Standard).`;
  } else {
    document.getElementById("result").innerHTML = `Value ${value} does not exist in the array.`;
  }
}
