...
function calculateTriangleArea() {
  ...
  if (isNaN(a) || isNaN(b) || isNaN(c)) {
    document.getElementById("triangleResult").innerHTML ="Please enter valid numbers for all sides.";
    document.getElementById("triangleResult").classList.add("error");
    return;
  }
  if (a <= 0 || b <= 0 || c <= 0) {
    document.getElementById("triangleResult").innerHTML ="Sides of triangle cannot be negative or zero.";
    document.getElementById("triangleResult").classList.add("error");
    return;
  }
  ...
  document.getElementById("triangleResult").innerHTML = `Area of the triangle is: ${area.toFixed(2)} square units`;
...
function calculateRectangleArea() {
  ...
  if (isNaN(length) || isNaN(width)) {
    document.getElementById("rectangleResult").innerHTML ="Please enter valid numbers for length and width.";
    document.getElementById("rectangleResult").classList.add("error");
    return;
  }
  if (length <= 0 || width <= 0) {
    document.getElementById("rectangleResult").innerHTML ="Side of rectangle cannot be negative or zero.";
    document.getElementById("rectangleResult").classList.add("error");
    return;
  }
  const area = length * width;

  document.getElementById("rectangleResult").innerHTML = `Area of the rectangle is: ${area.toFixed(2)} square units`;
...
function calculateCircleArea() {
  ...
  if (radius <= 0) {
    document.getElementById("circleResult").innerHTML ="Radius value cannot be negative or zero.";
    document.getElementById("circleResult").classList.add("error");
    return;
  }
  const area = Math.PI * Math.pow(radius, 2);

  document.getElementById("circleResult").innerHTML = `Area of the circle is: ${area.toFixed(2)} square units`;
